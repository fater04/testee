		...
		<div class="col-sm-12 event-inner">
			...
			?>
				...
				<div class="alert alert-warning event-closed" role="alert">
					<span class="fa fa-exclamation-triangle"></span><?php echo apply_filters( 'lendiz_event_close', esc_html__( 'Event closed.', 'lendiz' ) ); ?>
				</div>
			<?php 
				...
				?>
								...
								<div class="col-sm-<?php echo esc_attr( $event_col[$i++] ); ?>">
									<div class="event-info">
										<h4><?php echo apply_filters( 'lendiz_event_info_details', esc_html__( 'Event Details', 'lendiz' ) ); ?></h4>
										<?php
											...
											<p class="event-organizer">
												<span class="event-subtitle">
													<strong><?php
														echo apply_filters( 'lendiz_event_organizer_label', esc_html__( 'Organizer', 'lendiz' ) ); ?> : 
													</strong>
												</span>
											...
											<p class="event-start-date">
												<span class="event-subtitle">
													<strong><?php
														echo apply_filters( 'lendiz_event_start_label', esc_html__( 'Start Date', 'lendiz' ) ); ?> : 
													</strong>
												</span>
												<?php echo !empty( $date_format ) ? date( $date_format, strtotime( $event_date ) ) : $event_date; ?>
											</p><?php
											...
											<p class="event-end-date">
												<span class="event-subtitle">
													<strong><?php
														echo apply_filters( 'lendiz_event_end_label', esc_html__( 'End Date', 'lendiz' ) ); ?> : 
													</strong>
												</span>
											...
											<p class="event-time">
												<span class="event-subtitle">
													<strong><?php
														echo apply_filters( 'lendiz_event_time_label', esc_html__( 'Time', 'lendiz' ) ); ?> : 
													</strong>
												</span>
												<?php echo esc_html( $event_time ); ?>
											</p><?php
											...
											<p class="event-cost">
												<span class="event-subtitle">
													<strong><?php
														echo apply_filters( 'lendiz_event_cost_label', esc_html__( 'Cost', 'lendiz' ) ); ?> : 
													</strong>
												</span>
											...
											<p class="event-cost">
												<span class="event-subtitle">
													<strong><?php
														echo apply_filters( 'lendiz_event_cost_label', esc_html__( 'More About Event', 'lendiz' ) ); ?> : 
													</strong>
												</span>
						...
						?>
								...
								<div class="col-sm-<?php echo esc_attr( $event_col[$i++] ); ?>">
									<div class="event-venue">
										<h4><?php echo apply_filters( 'lendiz_event_venue_name', esc_html__( 'Event Venue', 'lendiz' ) ); ?></h4>
										...
										<p class="event-venue-name">
											<span class="event-subtitle">
												<strong><?php
													echo apply_filters( 'lendiz_event_venue_label', esc_html__( 'Venue', 'lendiz' ) ); ?> : 
												</strong>
											</span>
										...
										<p class="event-address">
											<span class="event-subtitle">
												<strong><?php
													echo apply_filters( 'lendiz_event_venue_address_label', esc_html__( 'Address', 'lendiz' ) ); ?> : 
												</strong>
											</span>
										...
										<p class="event-email">
											<span class="event-subtitle">
												<strong><?php
													echo apply_filters( 'lendiz_event_email_label', esc_html__( 'E-mail', 'lendiz' ) ); ?> : 
												</strong>
											</span>
										...
										<p class="event-phone">
											<span class="event-subtitle">
												<strong><?php
													echo apply_filters( 'lendiz_event_phone_label', esc_html__( 'Phone', 'lendiz' ) ); ?> : 
												</strong>
											</span>
										...
										<p class="event-website">
											<span class="event-subtitle">
												<strong><?php
													echo apply_filters( 'lendiz_event_website_label', esc_html__( 'Website', 'lendiz' ) ); ?> : 
												</strong>
											</span>
					...
					<div class="event-details-wrap">
						<ul class="event-details-inner">
							...
							<li class="event-start-date">
								<span class="event-subtitle">
									<strong><?php
										echo apply_filters( 'lendiz_event_date_label', esc_html__( 'Date: ', 'lendiz' ) ); ?>
									</strong>
								</span>
								<?php echo !empty( $date_format ) ? date( $date_format, strtotime( $event_date ) ) : $event_date; ?>
							</li><?php
				...
				<div class="col-sm-12">
					...
					?>
						<ul class="nav social-icons">
							<li><span class="event-share-title"><?php echo esc_html__( 'Share: ', 'lendiz' ); ?></span></li>
							<?php 
							if( $posts_shares ):
								foreach ( $posts_shares as $social_share ){
									...
									?>
											...
											<li><a href="http://twitter.com/intent/tweet?text=Reading:<?php echo urlencode(get_the_title()); ?>-<?php echo  esc_url( home_url( '/' ) )."/?p=". esc_attr( $post_id ); ?>" class="social-twitter share-twitter" title="<?php esc_html_e( 'Click to send this page to Twitter!', 'lendiz' ); ?>" target="_blank"><i class="ti-twitter"></i></a></li>
				...
				<div class="col-sm-12">
					<div class="event-contact-wrap">
						<div class="event-contact-title">
							<h3 class="event-form-title"><?php echo esc_html__( 'Event Going Registration', 'lendiz' ); ?></h3>
						</div>
