...
add_action( 'widgets_init', 'lendiz_zozo_social_load_widget' );

function lendiz_zozo_social_load_widget() {

	register_widget( 'lendiz_zozo_social_widget' );

}

class lendiz_zozo_social_widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'zozo_social_widget', 'description' => esc_html__('A widget that displays your social icons', 'lendiz-core') );
		...
		parent::__construct( 'zozo_social_widget', esc_html__('Lendiz Social Icons', 'lendiz-core'), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		<label for="<?php echo esc_attr( $this->get_field_id('socialstyle') ); ?>"><?php esc_html_e('Select Post Type:', 'lendiz-core'); ?></label> 
		...
		<select id="<?php echo esc_attr( $this->get_field_id('socialstyle') ); ?>" name="<?php echo esc_attr( $this->get_field_name('socialstyle') ); ?>" class="widefat" style="width:100%;">
			...
			<?php $social_style = array( "transparent" => esc_html__( 'Transparent', 'lendiz-core' ), "squared" => esc_html__( 'Squared', 'lendiz-core' ), "rounded" => esc_html__( 'Rounded', 'lendiz-core' ), "circled" => esc_html__( 'Circled', 'lendiz-core' ) ); ?>
		...
		<label for="<?php echo esc_attr( $this->get_field_id('social_icons_fore') ); ?>"><?php esc_html_e('Social Icons Fore:', 'lendiz-core'); ?></label> 
		...
		<select id="<?php echo esc_attr( $this->get_field_id('social_icons_fore') ); ?>" name="<?php echo esc_attr( $this->get_field_name('social_icons_fore') ); ?>" class="widefat" style="width:100%;">
			...
			<?php $social_icons_fore = array( "black" => esc_html__( 'Black', 'lendiz-core' ), "white" => esc_html__( 'White', 'lendiz-core' ), "own" => esc_html__( 'Own Color', 'lendiz-core' ) ); ?>
		...
		<label for="<?php echo esc_attr( $this->get_field_id('social_icons_hfore') ); ?>"><?php esc_html_e('Social Icons Fore Hover:', 'lendiz-core'); ?></label> 
		...
		<select id="<?php echo esc_attr( $this->get_field_id('social_icons_hfore') ); ?>" name="<?php echo esc_attr( $this->get_field_name('social_icons_hfore') ); ?>" class="widefat" style="width:100%;">
			...
			<?php $social_icons_hfore = array( "h-black" => esc_html__( 'Black', 'lendiz-core' ), "h-white" => esc_html__( 'White', 'lendiz-core' ), "h-own" => esc_html__( 'Own Color', 'lendiz-core' ) ); ?>
		...
		<label for="<?php echo esc_attr( $this->get_field_id('social_icons_bg') ); ?>"><?php esc_html_e('Social Icons Background:', 'lendiz-core'); ?></label> 
		...
		<select id="<?php echo esc_attr( $this->get_field_id('social_icons_bg') ); ?>" name="<?php echo esc_attr( $this->get_field_name('social_icons_bg') ); ?>" class="widefat" style="width:100%;">
			...
			<?php $social_icons_bg = array( "bg-transparent" => esc_html__( 'Transparent', 'lendiz-core' ), "bg-black" => esc_html__( 'Black', 'lendiz-core' ), "bg-white" => esc_html__( 'White', 'lendiz-core' ), "bg-light" => esc_html__( 'RGBA Light', 'lendiz-core' ), "bg-dark" => esc_html__( 'RGBA Dark', 'lendiz-core' ), "bg-own" => esc_html__( 'Own Color', 'lendiz-core' ) ); ?>
		...
		<label for="<?php echo esc_attr( $this->get_field_id('social_icons_hbg') ); ?>"><?php esc_html_e('Social Icons Background Hover:', 'lendiz-core'); ?></label> 
		...
		<select id="<?php echo esc_attr( $this->get_field_id('social_icons_hbg') ); ?>" name="<?php echo esc_attr( $this->get_field_name('social_icons_hbg') ); ?>" class="widefat" style="width:100%;">
			...
			<?php $social_icons_hbg = array( "hbg-transparent" => esc_html__( 'Transparent', 'lendiz-core' ), "hbg-black" => esc_html__( 'Black', 'lendiz-core' ), "hbg-white" => esc_html__( 'White', 'lendiz-core' ), "hbg-light" => esc_html__( 'RGBA Light', 'lendiz-core' ), "hbg-dark" => esc_html__( 'RGBA Dark', 'lendiz-core' ), "hbg-own" => esc_html__( 'Own Color', 'lendiz-core' ) ); ?>
		...
		<p><?php esc_html_e( 'Note: Set your social links in the Customizer', 'lendiz-core' ); ?></p>

		

		<p>

			<label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Show Facebook:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Show Twitter:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Show Instagram:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'pinterest' ) ); ?>"><?php esc_html_e( 'Show Pinterest:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'bloglovin' ) ); ?>"><?php esc_html_e( 'Show Bloglovin:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'googleplus' ) ); ?>"><?php esc_html_e( 'Show Google Plus:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'tumblr' ) ); ?>"><?php esc_html_e( 'Show Tumblr:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'youtube' ) ); ?>"><?php esc_html_e( 'Show Youtube:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Show Dribbble:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'soundcloud' ) ); ?>"><?php esc_html_e( 'Show Soundcloud:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'vimeo' ) ); ?>"><?php esc_html_e( 'Show Vimeo:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Show Linkedin:', 'lendiz-core' ); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'rss' ) ); ?>"><?php esc_html_e( 'Show RSS:', 'lendiz-core' ); ?></label>
