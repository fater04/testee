<?php
add_action( 'widgets_init', 'lendiz_zozo_fb_like_widget' );
function lendiz_zozo_fb_like_widget() {
	register_widget( 'lendiz_zozo_fb_widget' );
}
class lendiz_zozo_fb_widget extends WP_Widget {
	/**
	 * Widget setup.
	 */
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'zozo_fb_widget', 'description' => esc_html__('A widget that displays your latest posts from all categories or a certain', 'lendiz-core') );
		/* Widget control settings. */
		$control_ops = array('id_base' => 'zozo_fb_widget' );
		/* Create the widget. */
		parent::__construct( 'zozo_fb_widget', esc_html__('Facebook Like', 'lendiz-core'), $widget_ops, $control_ops );
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('FB Like', 'lendiz-core'), 'fblink' => '', 'fbname' => '');
		...
		<!-- Fb like Name -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fbname' ) ); ?>"><?php esc_html_e('Facebook Profile Name:', 'lendiz-core'); ?></label>
		...
		<!-- Fb like Link -->
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fblike' ) ); ?>"><?php esc_html_e('Facebook Link:', 'lendiz-core'); ?></label>
