...
class LendizThemeStyles {
	...
	function lendiz_border_settings($field){
	...
	function lendiz_padding_settings($field){
	...
	function lendiz_custom_font_face_create( $font_family, $cf_names ){
		$font_family = stripslashes( $font_family );
	...
	function lendiz_typo_ouput($field){
		...
		if( $typo ):
			...
			'. ( isset( $typo['font_family'] ) && $typo['font_family'] != '' ?  'font-family: '. stripslashes( $typo['font_family'] ) .';' : '' ) .'
