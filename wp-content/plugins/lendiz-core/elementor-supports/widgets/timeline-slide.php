<?php
/**
 * Lendiz Elementor Addon Timeline Slide
 *
 * @since 1.0.0
 */
class Elementor_Timeline_Slide_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( "Timeline Slide", "lendiz-core" );
	}
	...
	public function get_script_depends() {
		return [ 'lendiz-timeline', 'custom-front' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Event Line Distance", "lendiz-core" ),
				"description"	=> esc_html__( "This is option for timeline event line distance. If you use timeline for years make distance volume low.", "lendiz-core" ),
				"default" 		=> "60",
			]
		);	
		...
		$repeater->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Timeline Date", "lendiz-core" ),
				"description"	=> esc_html__( "Here you can put the timeline date. Must follow the date format dd/mm/yyyy. Example 16/01/2014", "lendiz-core" ),
				"default"		=> ""
			]
		);
		$repeater->add_control(
			...
			[
				"type"			=> \Elementor\Controls_Manager::TEXT,
				"label" 		=> esc_html__( "Timeline Separator Title", "lendiz-core" ),
		...
		$this->add_control(
			"timeline_settings",
			[
				"label"			=> esc_html__( "Timeline Setting", "lendiz-core" ),
				"description"	=> esc_html__( "This is options for timeline.", "lendiz-core" ),
				"type"			=> \Elementor\Controls_Manager::REPEATER,
				"fields"		=> $repeater->get_controls(),
				"default"		=> [
					[
						"timeline_title" 	=> esc_html__( "History", "lendiz-core" ),
						"timeline_date"		=> "01/01/2012",
						"timeline_separator"=> esc_html__( "01 Jan", "lendiz-core" ),
						"timeline_subtitle"	=> esc_html__( "1st January, 2012", "lendiz-core" ),
